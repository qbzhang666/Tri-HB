...
% ---------------- Bibliography -------------------------------------------------
\addbibresource{handbook_trihb V4.bib}
...
\item \textbf{Mode 6 -- Electromagnetic symmetric multidirectional}.
      ...
      specimen stress without exceeding the bar elastic limit \cite{xie2021}.
\end{enumerate}
...
\begin{figure}[htbp]
  ...
  \caption{Step~4 default sandstone asynchronous XYZ case: input, recoverable elastic, and estimated dissipated energy-density histories.}
