...
with st.expander("Equations used by Step 3: stress path and failure index", expanded=False):
    st.markdown("**Total stress histories, invariants and failure index**")
...
with st.expander("Equations used by Step 4: damage, energy and validation", expanded=False):
    st.markdown("**Damage variable and rate law**")
    ...
    st.markdown("**Energy-density indicators**")
    ...
    st.markdown("**Validation descriptors and delay sensitivity**")
